...
class EMUSftTokenizer(EMUImageOnlyTokenizer):
    ...
    def _format_to_messages(self, text):
        """
        Convert conversation format to standard messages format.

        Args:
            text: List of {"user": str, "assistant": str} dicts

        Returns:
            List of message dicts formatted for tokenize_conversation
        """
        messages = []
